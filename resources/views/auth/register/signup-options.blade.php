            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="auth-body col-10 m-auto rounded p-4 mt-5 text-center">
                        <a id="gawazy-btn" class="btn m-2 pt-2" href="{{ route('user-register') }}">{{ __('auth.user') }}</a>
                        <a id="gawazy-btn" class="btn m-2 pt-2" href="{{ route('vendor-register') }}">{{ __('auth.vendor') }}</a>
                        <div>
