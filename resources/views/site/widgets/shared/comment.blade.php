<div class="row gawazy-bg pt-3 m-3">
    ...
    <div class="d-flex justify-content-around">
        <div class="col-2 col-xxl-1 text-center">
            ...
            <p class="gawazy-font-primary">user name</p>
        </div>
        ...
        <div class="col-4 col-md-3 col-lg-2">
            <div class="d-flex">
                <a href=""><div class="action px-3 py-1 mx-1 rounded-3 gawazy-secondary"><img src="{{ url('images/icons/like-w.png') }}" class="like-btn" alt=""></div></a>
                <a href=""><div class="action px-3 py-1 mx-1 rounded-3 gawazy-secondary"><img src="{{ url('images/icons/dislike-w.png') }}" class="like-btn"></div></a>
            </div>
            <div class="d-flex">
